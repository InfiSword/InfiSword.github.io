  ...
  <div class="pf-flowchart">
    ...
    <div class="pf-fc-card pf-fc-compact">
      <div class="pf-fc-card-header">
        <h4 class="pf-fc-title">1단계: 타입 메타데이터 수집 (Type Info)</h4>
        <span class="pf-fc-badge">REFLECTION</span>
      </div>
      <p class="pf-fc-desc">제네릭 타입 `T`의 모든 필드 정보(`FieldInfo[]`)를 리플렉션으로 추출 및 캐싱</p>
    </div>
    ...
    <div class="pf-fc-card pf-fc-compact">
      <div class="pf-fc-card-header">
        <h4 class="pf-fc-title">2단계: 헤더 추출 및 딕셔너리 매핑 (Header Map)</h4>
        <span class="pf-fc-badge">INDEXING</span>
      </div>
      <p class="pf-fc-desc">CSV 1행 헤더명을 분리하여 클래스 필드명과 1:1 대응되는 열 인덱스 사전 구축</p>
    </div>
    ...
    <div class="pf-fc-card pf-fc-compact">
      <div class="pf-fc-card-header">
        <h4 class="pf-fc-title">3단계: 정규식 스마트 분할 및 인스턴스화 (SmartSplit)</h4>
        <span class="pf-fc-badge" style="background: #eff6ff; color: #2563eb; border-color: #bfdbfe;">PARSER</span>
      </div>
      <p class="pf-fc-desc">따옴표 및 쉼표 예외 정규식 파싱 후 `Activator.CreateInstance&lt;T&gt;()`로 DTO 객체 생성</p>
    </div>
    ...
    <div class="pf-fc-card pf-fc-compact" style="border-color: #bfdbfe; background: #f8fbff;">
      <div class="pf-fc-card-header">
        <h4 class="pf-fc-title" style="color: #1d4ed8;">4단계: 동적 타입 변환 및 필드 바인딩 (Binding)</h4>
        <span class="pf-fc-badge">BIND</span>
      </div>
      <p class="pf-fc-desc">`Convert.ChangeType`으로 string 데이터를 실제 필드 타입(int, float 등)으로 자동 변환 후 값 할당</p>
    </div>
...
<div class="pf-visual-frame pf-flowchart-frame">
  <div class="pf-flowchart">
    ...
    <!-- Header Fields Grid -->
    <div class="pf-fc-branch-grid" style="grid-template-columns: 2fr 1fr; width: 100%;">
      <div class="pf-fc-branch-item pf-fc-item-compact" style="border-color: #93c5fd; background: #f8fbff;">
        <span class="pf-fc-badge">HEADER 01</span>
        <div class="pf-fc-branch-title" style="margin-top: 5px;">BaseSeed (루트 시드)</div>
        <div class="pf-fc-branch-desc"><strong>20자리 고정</strong> (ulong 최대 자릿수 0-패딩)</div>
      </div>
      <div class="pf-fc-branch-item pf-fc-item-compact" style="border-color: #93c5fd; background: #f8fbff;">
        <span class="pf-fc-badge">HEADER 02</span>
        <div class="pf-fc-branch-title" style="margin-top: 5px;">Domain 개수</div>
        <div class="pf-fc-branch-desc"><strong>3자리 고정</strong> (예: `008`)</div>
      </div>
    </div>
    ...
    <div class="pf-fc-card pf-fc-compact" style="border-color: #86efac; background: #f0fdf4;">
      <div class="pf-fc-card-header">
        <h4 class="pf-fc-title" style="color: #15803d;">Domain 레코드 블록 (도메인 개수만큼 반복 병합)</h4>
        <span class="pf-fc-badge" style="background: #dcfce7; color: #166534; border-color: #bbf7d0;">PAYLOAD</span>
      </div>
      <div class="pf-fc-branch-grid" style="grid-template-columns: 1fr 2fr; margin-top: 10px;">
        <div class="pf-fc-branch-item pf-fc-item-compact" style="background: #fff;">
          <strong style="color: #16a34a;">Domain ID</strong>
          <p style="margin: 4px 0 0 0; font-size: 0.8rem; color: #64748b;">3자리 고정 패딩 (도메인 식별자)</p>
        </div>
        <div class="pf-fc-branch-item pf-fc-item-compact" style="background: #fff;">
          <strong style="color: #16a34a;">Usage Count</strong>
          <p style="margin: 4px 0 0 0; font-size: 0.8rem; color: #64748b;">12자리 고정 패딩 (RNG 난수 소비 횟수)</p>
        </div>
      </div>
    </div>
