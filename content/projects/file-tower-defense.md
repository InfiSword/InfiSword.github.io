...
<section id="gallery" class="pf-ftd-post-gallery-section">
    <div class="pf-ftd-section-header">
        ...
        <p class="pf-ftd-section-desc">바탕화면 파일 유닛 배치부터 상위 확장 유닛, 언락 상점(UnLock Shop), 긴급 보스전까지 주요 게임플레이 화면을 넘겨가며 옆으로 스크롤하여 확인할 수 있습니다.</p>
    </div>

    <!-- INTERACTIVE SCREENSHOT GALLERY (HORIZONTAL SCROLL & SLIDER) -->
    <div class="pf-ftd-gallery" id="pfFtdGalleryPost">
        <!-- Topbar Meta & Actions -->
        <div class="pf-ftd-gallery-topbar">
            <div class="pf-ftd-gallery-meta">
                <span class="pf-ftd-counter pf-mono">01 / 05</span>
                <span class="pf-ftd-caption">파일 유닛 배치 및 웨이브 방어</span>
            </div>
            <a href="https://www.youtube.com/watch?v=LNJKQiQ8ahs" target="_blank" rel="noopener noreferrer" class="pf-ftd-yt-link" title="YouTube 시연 영상 새 창으로 열기">
        ...
        <div class="pf-ftd-stage">
            ...
            <img class="pf-ftd-main-img" src="/assets/images/File%20Tower%20Defences/ftd_screenshot_01.png" alt="파일 유닛 배치 및 웨이브 방어" loading="eager">
        ...
        <div class="pf-ftd-thumbs-wrapper">
            <div class="pf-ftd-thumbs-strip" role="region" aria-label="스크린샷 썸네일 가로 스크롤 목록">
                <button type="button" class="pf-ftd-thumb-card is-active" data-index="0" data-title="파일 유닛 배치 및 웨이브 방어" onclick="pfFtdGallerySelect(0, this)" title="1. 파일 유닛 배치 및 웨이브 방어">
                    <img src="/assets/images/File%20Tower%20Defences/ftd_screenshot_01.png" alt="1. 파일 유닛 배치 및 웨이브 방어" loading="lazy">
                    <span class="pf-ftd-thumb-num pf-mono">01</span>
                </button>
                <button type="button" class="pf-ftd-thumb-card" data-index="1" data-title="상위 확장 유닛 배치 & 팝업창 바이러스 침공" onclick="pfFtdGallerySelect(1, this)" title="2. 상위 확장 유닛 배치 & 팝업창 바이러스 침공">
                    <img src="/assets/images/File%20Tower%20Defences/ftd_screenshot_02.png" alt="2. 상위 확장 유닛 배치 & 팝업창 바이러스 침공" loading="lazy">
                    <span class="pf-ftd-thumb-num pf-mono">02</span>
                </button>
                <button type="button" class="pf-ftd-thumb-card" data-index="2" data-title="인게임 언락 상점(UnLock Shop) 시스템" onclick="pfFtdGallerySelect(2, this)" title="3. 인게임 언락 상점(UnLock Shop) 시스템">
                    <img src="/assets/images/File%20Tower%20Defences/ftd_screenshot_03.png" alt="3. 인게임 언락 상점(UnLock Shop) 시스템" loading="lazy">
                    <span class="pf-ftd-thumb-num pf-mono">03</span>
                </button>
                <button type="button" class="pf-ftd-thumb-card" data-index="3" data-title="긴급 보스전 - 내 PC 소화 중..." onclick="pfFtdGallerySelect(3, this)" title="4. 긴급 보스전 - 내 PC 소화 중...">
                    <img src="/assets/images/File%20Tower%20Defences/ftd_screenshot_04.png" alt="4. 긴급 보스전 - 내 PC 소화 중..." loading="lazy">
                    <span class="pf-ftd-thumb-num pf-mono">04</span>
                </button>
                <button type="button" class="pf-ftd-thumb-card" data-index="4" data-title="후반부 보스전 및 차원 웜홀 기믹" onclick="pfFtdGallerySelect(4, this)" title="5. 후반부 보스전 및 차원 웜홀 기믹">
                    <img src="/assets/images/File%20Tower%20Defences/ftd_screenshot_05.png" alt="5. 후반부 보스전 및 차원 웜홀 기믹" loading="lazy">
