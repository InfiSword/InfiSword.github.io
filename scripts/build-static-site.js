...
function isHtmlLine(line) {
  return /^<!--|^<\/?(style|script|div|span|p|h1|h2|h3|h4|h5|h6|table|thead|tbody|tr|th|td|details|summary|img|br|hr|strong|em|code|section|article|figure|figcaption|ul|ol|li|svg|line|polyline|circle|rect|path|g|polygon|text|tspan|defs|marker|filter|feDropShadow|fe[A-Za-z]+|a|button)\b/i.test(
    line.trim()
  );
}
